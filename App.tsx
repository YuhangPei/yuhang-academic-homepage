...
const BootSequence: React.FC<{ onComplete: () => void }> = ({ onComplete }) => {
  ...
  useEffect(() => {
    const bootLines = [
      ...
      "LOADING MODULES: [NEU_PHD] [PROJECTS] [PUBLICATIONS]",
      "LOADING DATABASE: SIGKDD... EMNLP... ICML... LOADED.",
                ...
                <div className="space-y-6">
                  {PAPERS.map((paper, idx) => (
                    <div key={idx} className="group relative pl-6 border-l-4 border-slate-700 hover:border-blue-500 transition-colors">
                      ...
                      <h3 
                        className="text-lg font-bold text-slate-100 group-hover:text-blue-400 cursor-pointer leading-snug"
